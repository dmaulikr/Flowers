...
-(id) init
{
	...
	if( (self=[super init] )) {
		CCSprite *background = [CCSprite spriteWithFile:@"aboutbg.png"];
		...
		[mainMenu setPosition:ccp(350,30)];
...
-(void)mainmenu:(id)sender {
	...
	[[CCDirector sharedDirector] replaceScene:[CCTransitionSlideInR transitionWithDuration:1 scene:[MainMenu node]]];
}
